...
const { addTown, getTownById, getAllTowns, getTownsByUser, updatePlotStatusAndDealer, deleteDealerfromPlot, updateTownById, deleteTownById } = require("../controllers/town.controller");
